...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel(
				"<html>Which is a real fruit? <br> A: Jack Fruit <br> B: Star Banana <br> C: Loop Fruit</html>");
		question3 = new JLabel("<html>Which is a berry? <br> A: Raspberry <br> B: Banana <br> C: Strawberry</html>");
		question4 = new JLabel("<html>Is Avocado a fruit? <br> A: No <br> B: IDK <br> C: Yes</html>");
